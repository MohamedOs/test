...
$.tabgroup.addEventListener('open',function(){
	var actionBar = $.tabgroup.activity.actionBar; // get a handle to the action bar
	actionBar.title='حراج قطر'; // change the App Title
...
var adMobView = Admob.createView({
	  publisherId:"ca-app-pub-7385551161390893/9220312167",
  //  publisherId:"7385551161390893",
...
var adMobView4 = Admob.createView({
	  publisherId:"ca-app-pub-7385551161390893/9220312167",
  //  publisherId:"7385551161390893",
    testing:false, // default is false
    //top: 10, //optional
...
var adMobView5 = Admob.createView({
	  publisherId:"ca-app-pub-7385551161390893/9220312167",
  //  publisherId:"7385551161390893",
    testing:false, // default is false
    //top: 10, //optional
...
var adMobView6 = Admob.createView({
	  publisherId:"ca-app-pub-7385551161390893/9220312167",
  //  publisherId:"7385551161390893",
    testing:false, // default is false
    //top: 10, //optional
...
var adMobViewx = Admob.createView({
	  publisherId:"ca-app-pub-7385551161390893/9220312167",
  //  publisherId:"7385551161390893",
    testing:false, // default is false
    //top: 10, //optional
...
var adMobViewx = Admob.createView({
	  publisherId:"ca-app-pub-7385551161390893/5900245767",
  //  publisherId:"7385551161390893",
    testing:false, // default is false
    //top: 10, //optional
    //left: 0, // optional
...
var begin='<html><head><link rel="stylesheet" type="text/css" href="theme.css">';    
begin+='<meta http-equiv="Content-Type" CONTENT="text/html; charset=utf-8">';
begin+='<meta name="viewport" content="target-densitydpi=device-dpi, initial-scale=1.0, user-scalable=no" />';
begin+='<meta name="apple-mobile-web-app-capable" content="yes" /><style>dir:rtl;</style>';
...
function openLink (e){
	Ti.Platform.openURL("http://3r2y.com/");
}
...
function picPhoto(){
    ...
    imagexx=event.media;
   // alert(event.media);
   $.picPhoto.backgroundColor="none";
$.picPhoto.backgroundImage=imagexx;
	}
});
}
function sendPosts(){
	$.addWin.close();
		alert("تم اضافة الاعلان بنجاح! سيتم مراجعتة اولا من قبل الموظف المختص قبل ظهوره!");
