...
var queryIndex='select * from html where url="http://hihi2.com/category/alittihad-saudi-news/page/'+pageNumber+'" and xpath="//*[@id=\'content-loop\']"';
...
for (var i=0,a=0;i<data2.length,a<data2.length;i++,a+=2) {
arr.push({
image:data2[i],
